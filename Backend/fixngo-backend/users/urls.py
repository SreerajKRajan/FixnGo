...
from .views import UserSignupView, UserLoginView, UserLogoutView, OtpVerificationView, UserProfileView, UserForgotPasswordView, ResetPasswordView, NearbyWorkshopsView
