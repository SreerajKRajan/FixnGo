      ...
      <main className="container mx-auto mt-12 px-4">
        <section className="text-center">
          ...
          <p className="text-xl mb-8">
            Connect with nearby workshops instantly when you need help on the
            road.
          </p>
          <Link
            to="/signup"
        ...
        <section className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Feature
            icon={<FaWrench className="text-5xl text-blue-500" />}
            title="Connect with Workshops"
            description="Find and connect with nearby workshops quickly and easily."
          />
          <Feature
            icon={<FaMapMarkedAlt className="text-5xl text-green-500" />}
            title="Live Tracking"
          ...
          />
          <Feature
            icon={<FaComments className="text-5xl text-yellow-500" />}
            title="Instant Chat"
        ...
        <section className="mt-16 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="font-semibold mb-2">1. Request Service</h3>
              <p>Send a service request with your location and issue details.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="font-semibold mb-2">2. Get Connected</h3>
              <p>Nearby workshops receive your request and can accept it.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="font-semibold mb-2">3. Receive Assistance</h3>
              <p>Track, communicate, and get the help you need on the road.</p>
            </div>
          </div>
        </section>
